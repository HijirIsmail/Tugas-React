            ...
            <React.Fragment>
                ...
                <div className="corona-body">
                    <div className="container">
                        <div>
                            <center className="judul">Covid-19 Data Tracker</center>
                            <br />
                            <div className="name">
                    ...
                    <div className="container">
                        <div className="card-deck card-decks">
                            ...
                            <br/>
                                    ...
                                    <div class="pindah-pageutama">
                                        <form method="get" action="https://hijirismail.github.io/">
                                            <button type="kembali" name="button">Kembali ke Halaman Utama</button>
                                        </form>
                                    </div>
                </div>
            </React.Fragment>
